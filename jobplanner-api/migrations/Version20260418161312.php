...
final class Version20260418161312 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user_mailbox_settings DROP CONSTRAINT fk_user_mailbox_settings_user');
        $this->addSql('ALTER TABLE user_mailbox_settings DROP CONSTRAINT uq_user_mailbox_settings_user');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user_mailbox_settings DROP CONSTRAINT uq_23f5ef9fa76ed395');
